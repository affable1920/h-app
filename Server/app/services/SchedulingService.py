...
from app.schemas.enums import AppointmentStatus, Mode
...
class ScheduleService:
    ...
    async def create_schedule(
        ...
        try:
            ...
            logger.info(f"Exception cause: {e.__cause__}")
            logger.info(f"Exception context: {e.__context__}")
            logger.info(f"Exception traceback: {e.__traceback__}")
